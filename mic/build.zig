...
pub fn build(b: *std.Build) void {
    ...
    // Create the mic module
    const mic_mod = b.addModule("mic", .{
    ...
    test_step.dependOn(&b.addRunArtifact(mount_tests).step);
    ...
    // No FFI artifacts or header sync tests (CLI-first, no libmic-core).
}
