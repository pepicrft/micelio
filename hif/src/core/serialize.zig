//! Binary serialization for hif core types.
//!
...
/// Magic bytes identifying hif binary format.
pub const MAGIC: [4]u8 = .{ 'H', 'I', 'F', 0x01 };
...
/// Serialize a bloom filter with HIF header.
...
/// Deserialize a bloom filter with HIF header verification.
...
/// Serialize an HLC timestamp with HIF header.
...
/// Deserialize an HLC timestamp with HIF header verification.
