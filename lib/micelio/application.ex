  ...
  def start(_type, _args) do
    children =
      [
        ...
        Micelio.Repo,
        Micelio.Errors.Telemetry,
        Micelio.Errors.RateLimiter,
        Micelio.Abuse.Blocklist,
        Micelio.Theme.Server,
        {Task.Supervisor, name: Micelio.Errors.Supervisor},
        ...
        Micelio.Errors.RetentionScheduler,
        Micelio.Storage.S3RevalidationScheduler,
